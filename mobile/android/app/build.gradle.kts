...
android {
    ...
    compileOptions {
        ...
        // Required unconditionally by flutter_local_notifications 10+, even
        // though this app only calls .show() and never schedules -- see the
        // plugin's README "Adding the desugaring dependency".
